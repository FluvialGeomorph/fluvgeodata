...
This R package contains data required to test the fluvgeo package.
...
To install the `fluvgeodata` package, install from GitHub using the
`remotes` package:

    remotes::install_github(repo = "FluvialGeomorph/fluvgeodata@*release")

## Bug Reports

If you find any bugs using `fluvgeo`, please open an
[issue](https://github.com/FluvialGeomorph/fluvgeodata/issues).
